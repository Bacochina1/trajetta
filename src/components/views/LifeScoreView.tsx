...
export function LifeScoreView() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-16">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#0E1218] border border-white/10 p-4 sm:p-8 shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            ...
            <div className="flex items-baseline gap-2.5 sm:gap-3">
              <span className="text-4xl sm:text-6xl font-black text-[#B8FF00] tracking-tight">
                {overallScore}
              </span>
              <span className="text-base sm:text-lg font-bold text-[#8E9499]">/ 100</span>
            </div>

            <p className="text-xs sm:text-sm text-[#8E9499] max-w-xl leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-4 pt-1 text-xs text-[#F2F1ED]">
              <span className="flex items-center gap-1.5 bg-[#171A1D] px-2.5 sm:px-3 py-1.5 rounded-xl border border-white/6 text-[11px] sm:text-xs">
                <Flame size={13} className="text-[#F08A76]" />
          ...
          <div className="flex flex-col sm:flex-row md:flex-col gap-2.5 sm:gap-3 flex-shrink-0">
            <button
              onClick={() => setIsShareOpen(true)}
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-3.5 rounded-xl bg-[#171A1D] hover:bg-white/10 text-[#F2F1ED] border border-white/12 font-bold text-xs transition-all active:scale-95 shadow-md w-full sm:w-auto"
            >
              <Share2 size={15} className="text-[#B8FF00]" />
              <span>Gerar Card Instagram (9:16)</span>
            </button>
            <span className="text-[10px] sm:text-[11px] text-center text-[#8E9499]">
