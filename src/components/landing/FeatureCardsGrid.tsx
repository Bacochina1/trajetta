      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col group">
          ...
          <div className="relative w-full min-h-[290px] sm:aspect-[4/3.5] rounded-xl overflow-hidden border border-white/10 bg-[#0c0e12] flex items-center justify-center p-4 sm:p-6 shadow-2xl">
            ...
            <div className="relative z-10 w-full max-w-[250px] flex flex-col items-center">
              {/* Node 1: Domingo Planejamento */}
              <div className="bg-[#181c22]/90 border border-white/10 text-[11px] font-mono text-neutral-200 px-3.5 py-1.5 rounded-md shadow-lg flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#B8FF00]"></span>
                <span>Domingo: Planejamento Leve</span>
              </div>

              {/* Connector Line */}
              <div className="w-[1px] h-4 bg-neutral-600/70"></div>

              {/* Node 2: 3 Prioridades Reais */}
              <div className="w-full bg-[#161a20]/90 border border-white/10 px-3 py-2 rounded-md flex items-center space-x-2.5 text-[11px] font-mono text-neutral-300 shadow-lg">
        ...
        <div className="flex flex-col group">
          ...
          <div className="relative w-full min-h-[290px] sm:aspect-[4/3.5] rounded-xl overflow-hidden border border-white/10 bg-[#0c0e12] flex items-center justify-center p-4 sm:p-6 shadow-2xl">
            ...
            <div className="relative z-10 w-full max-w-[315px] bg-[#14181f]/95 border border-white/15 rounded-xl p-4 shadow-2xl backdrop-blur-md">
              ...
              {/* Chat Content Body */}
              <div className="pt-3 pb-3 text-[11px] leading-relaxed text-neutral-300 font-sans space-y-2">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-white/5 text-neutral-400 text-[11px]">
                <div className="flex items-center space-x-3">
                  <button className="hover:text-white transition-colors" title="Regenerar">
                    <RefreshCw className="w-3.5 h-3.5" />
                  </button>
                  <button className="hover:text-white transition-colors" title="Copiar">
                    <Copy className="w-3.5 h-3.5" />
                  </button>
                  <button className="hover:text-white transition-colors" title="Salvar">
        ...
        <div className="flex flex-col group">
          ...
          <div className="relative w-full aspect-[4/3.5] rounded-xl overflow-hidden border border-white/10 bg-[#0c0e12] flex items-center justify-center p-6 shadow-2xl">
            ...
            <div className="relative z-10 w-full max-w-[280px] space-y-2.5">
              ...
              <div className="bg-[#151921]/95 border border-white/15 px-3 py-2 rounded-xl flex items-center justify-between text-[11px] shadow-lg backdrop-blur-sm">
                <div className="flex items-center space-x-2 text-neutral-300 truncate mr-2">
                  <RotateCcw className="w-3.5 h-3.5 text-neutral-400 flex-shrink-0" />
                  <span className="truncate">Retomada sem culpa após pausa</span>
                </div>
                <button className="bg-white hover:bg-neutral-100 text-black font-semibold text-[10px] px-2.5 py-1 rounded-md transition-colors flex-shrink-0">
                  Recalcular
                </button>
              </div>
