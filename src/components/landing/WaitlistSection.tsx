  ...
  return (
    <section className="max-w-[1440px] mx-auto px-4 xs:px-6 sm:px-10 lg:px-14 py-16 sm:py-28 border-t border-white/10" data-purpose="pricing-plans" id="waitlist">
      ...
      <div className="relative rounded-2xl sm:rounded-3xl bg-[#090c10] border border-white/15 p-4 xs:p-6 sm:p-10 lg:p-12 overflow-hidden shadow-2xl mb-14">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            {successData ? (
              <div className="bg-[#12161e] border border-white/20 rounded-2xl p-6 sm:p-8 space-y-4 text-left">
                <div className="w-12 h-12 rounded-full bg-[#B8FF00]/15 border border-[#B8FF00]/30 flex items-center justify-center text-[#B8FF00]">
                  <CheckCircle2 className="w-6 h-6" />
                </div>

                <div>
                  <span className="text-xs font-mono uppercase tracking-widest text-[#B8FF00]">
                    Vaga VIP Reservada
                  </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto inline-flex items-center justify-center space-x-2.5 bg-white hover:bg-neutral-100 disabled:bg-neutral-400 text-black text-xs sm:text-sm font-bold tracking-wider uppercase px-8 py-4 rounded-full transition-all active:scale-95 shadow-xl shadow-white/5 cursor-pointer mt-2"
                >
          ...
          <div className="lg:col-span-5 bg-[#0f131a] border border-white/10 rounded-2xl p-6 sm:p-7 space-y-4">
            ...
            <div className="space-y-3 font-sans text-xs text-neutral-300 leading-relaxed">
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-[#B8FF00] flex-shrink-0 mt-0.5" />
                <span><strong>Acesso antecipado ao Trajetta AI:</strong> Modelo Google Gemini Flash com memória ativa de ciclos.</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-2xl bg-[#090c10] border border-white/10 p-7 flex flex-col justify-between hover:border-white/20 transition-all">
          <div>
            <span className="text-xs font-mono text-neutral-400 uppercase tracking-wider">Benefício 01</span>
            <h3 className="text-lg font-medium text-white mt-2 mb-3">Valor Travado de Fundador</h3>
          ...
          <div className="pt-6 mt-4 border-t border-white/5 text-xs font-mono text-neutral-500">
        ...
        <div className="rounded-2xl bg-[#090c10] border border-white/10 p-7 flex flex-col justify-between hover:border-white/20 transition-all">
          <div>
            ...
            <h3 className="text-lg font-medium text-white mt-2 mb-3">Onboarding da Estrela-Guia</h3>
            <p className="text-xs text-neutral-400 leading-relaxed font-light">
        ...
        <div className="rounded-2xl bg-[#090c10] border border-white/10 p-7 flex flex-col justify-between hover:border-white/20 transition-all">
          <div>
            ...
            <h3 className="text-lg font-medium text-white mt-2 mb-3">IA com Memória Expandida</h3>
            <p className="text-xs text-neutral-400 leading-relaxed font-light">
